    	...
    	<div class="container">    		
	    	...
	    	<div class="itemBox">
	    		<c:forEach var="auction" items="${autionList}">	    			
		    		<dl onClick="location.href='<c:url value="/mycompany/myServiceUpdate.do?memNo=${user.no}&comInfoNo=${auction.comInfoNo}"/>'" style="cursor:pointer;">
		    			<dt>
		    				<img src="<c:url value="/${auction.comFilePath}/${auction.comFileName}"/>" class="img-responsive center-block">
		    			</dt>
		    			<dd>
		    				<h6 class="comType">
		    					<c:choose>
	    	...
	    	<div class="btnBox">
	    		<a href="<c:url value="/mycompany/myService.do"/>" class="insertBtn">
	    			<i class="fas fa-plus"></i> 서비스 등록하기
	    		</a>
	    	</div>
    	</div>
    </div>   
