		...
		<div id="outer_budget">
			...
			<div class="infoBox cf">
				...
				<div class="col-md-6 no-padding info_right">
					...
					<div class="progressBar">
						<p style="font-size: 23px; font-family: 맑은고딕; font-weight: 700;">예산
							진행도</p>
						<c:choose>
							<c:when test="${spendBudget==0}">
								<c:set var="t" value="0" />
							...
							<c:otherwise>
								<fmt:parseNumber var="t" value="${spendBudget/3000*100}"
									integerOnly="true" />
							</c:otherwise>
						</c:choose>
						<div class="progress" style="height: 20px;">
						...
						<p style="font-size: 22px; text-align: right;">${spendBudget}
							out of 3000</p>
						<p
								...
								<tbody>
									...
									<c:forEach var="bList" items="${budgetList}">
										<tr id="${bList.budgNo}">
											...
											<td><a href="#" class="updateIcon"
												data-budgno="${bList.budgNo}"><i class="fas fa-pen"></i></a>
												<a href="#" onclick="deleteBudget(${bList.budgNo})"><i
									...
									<form id="writeBudgetForm" method="post">
										...
										<tr>
											<td><select id="budgCategory" name="budgCategory">
											...
											<td><input type="text" id="budgContent"
												name="budgContent" placeholder="항목을 입력하세요."></td>
											<td><input type="text" id="budgBudget" name="budgBudget"
												placeholder="예산을 입력하세요.">만원</td>
											<td><input type="text" id="budgExpenses"
												name="budgExpenses" placeholder="지출을 입력하세요.">만원</td>
											<td><a href="#" id="writeBtn"><i class="fas fa-pen"></i></a>
											</td>
										</tr>
									</form>
								</tbody>
