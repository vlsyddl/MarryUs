...
<body>
    ...
    <div id="wrap" class="main">
        <div class="main_visual">
            ...
            <div class="textBox">
                <h1>
                        What matters in a happy marriage is not how well they fit together. <br>
                        How do you get over the difference?
                </h1>
            </div>
            <div class="btnBox">
                <a href="#"  data-toggle="modal" data-target="#planingModal" class="mainBtn">
                    나만의 웨딩 플래닝
                </a>
            </div>
            <div class="deadLine">
            ...
            <div class="container">
                <ul class="statusList">
                    <li>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h5 class="v-roll-title"><a href="#">입찰중 역경매</a></h5>
                                <ul class="v-roll">
                                    <li>
                                        <span class="w18"><span>입찰중</span></span>
                                        <span class="w18">이O재</span>
                                        <span class="w28">서울시 강동구</span>
                                        <span class="w18">D-21일</span>
                            ...
                            <div class="col-md-6">
                                    ...
                                    <ul class="v-roll">
                                        <li>
                                            <span class="w18"><span>낙찰</span></span>
                                            <span class="w18">이O재</span>
                                            <span class="w28">서울시 강동구</span>
                                            <span class="w36">총 1,1501,5400원</span>
                                        </li>
                                        <li>
                                            <span class="w18"><span>낙찰</span></span>
                                            <span class="w18">이O재</span>
                    ...
                    <figure class="wow bounceIn" data-wow-delay="0.5s" >
                        ...
                        <figcaption>
                            <dl>
                                ...
                                <dd><span class="name">aawsdaa</span>님 <span class="date">2018.11.16</span></dd>
                            </dl>
                        </figcaption>
                    </figure>
    ...
    <div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body Page Page--login .Util-not-loaded">
                    <nav class="Login-navigation">
                      <ul class="Login-navigation__list">
                        <li class="Login-navigation__list-item">
                          <a class="Login-navigation__link" data-goto="Login-card--login">Login</a>
                        </li>
                        <li class="Login-navigation__list-item">
                          <a class="Login-navigation__link" data-goto="Login-card--register">Register</a>
                        </li>
                        <li class="Login-navigation__list-item">
                          <a class="Login-navigation__link" data-goto="Login-card--connect">Connect directly</a>
                        </li>
                      </ul>
                    </nav>
                    ...
                    <main class="Login-main">
                      <div class="Login-card-container">
                          ...
                          <form method="post" action="/marryus/main/login.do" name="loginForm">
                            ...
                            <div class="Form__form-group">
                              ...
                              <div class="Form__input-group">
                                <input type="text" name="email" placeholder="E-mail address" class="Form__input Login-card__email-input">
                              </div>
                              ...
                              <div class="Form__input-group">
                                <input type="submit" value="Login" class="Form__button Login-card__submit-button">
                              </div>
                        ...
                        <section class="Login-card Login-card--register Login-card--hidden" data-order="2">
                          ...
                          <form>
                            ...
                            <div class="Form__form-group">
                              ...
                              <div class="Form__input-group">
                                <input type="password" name="password_repeat" placeholder="Repeat password" class="Form__input Login-card__password-input">
                              </div>
                    
                              <div class="Form__input-group">
                                <input type="submit" value="Register" class="Form__button Login-card__submit-button">
                              </div>
                        ...
                        <section class="Login-card Login-card--connect Login-card--hidden" data-order="3">
      ...
      <!--플래닝-->
      <div class="modal fade" id="planingModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      ...
      <div id="chatBot">
          <h1 class="title"><i class="fas fa-question"></i></h1>
          <div class="btnClosed">
