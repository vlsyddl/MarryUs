...
!function () {
    ...
    var LobiboxBase = {
        ...
        _processInput: function (options) {
            if ($.isArray(options.buttons)) {
                for (var btns =
                    {}, i = 0; i < options.buttons.length; i++) 
                btns[options.buttons[i]] = Lobibox
                    .base
                    .OPTIONS
                    .buttons[options.buttons[i]];
        ...
        for (var i in options.buttons) 
            ...
            void 0 === options.showClass && (options.showClass = Lobibox
                .base
                .OPTIONS
                .showClass),
            void 0 === options.hideClass && (options.hideClass = Lobibox
                .base
                .OPTIONS
                .hideClass),
            void 0 === options.baseClass && (options.baseClass = Lobibox
                .base
                .OPTIONS
                .baseClass),
            void 0 === options.delayToRemove && (options.delayToRemove = Lobibox
                .base
                .OPTIONS
                .delayToRemove),
            options.iconClass || (options.iconClass = Lobibox
                .base
                .OPTIONS
                .icons[options.iconSource][this.$type]),
            options
    ...
    _createMarkup: function () {
        ...
        if (lobibox.append(header), lobibox.append(body), me.$options.buttons && !$.isEmptyObject(me.$options.buttons)) {
            ...
            Lobibox
                ...
                .OPTIONS
                .buttonsAlign
                .indexOf(me.$options.buttonsAlign) > -1 && footer.addClass("text-" + me.$options.buttonsAlign)
        }
        me.$el = lobibox.addClass(Lobibox
            .base
            .OPTIONS
            .modalClasses[me.$type])
    },
    _setSize: function () {
        var me = this;
    ...
    hide: function () {
        function callback() {
            ...
            0 === $(".lobibox[data-is-modal=true]:not(.lobibox-hidden)").length && ($(".lobibox-backdrop").remove(), $("body").removeClass(Lobibox
                .base
                .OPTIONS
                .bodyClass))
        }
        var me = this;
        return me.$options.hideClass
            ? (me.$el.removeClass(me.$options.showClass), me.$el.addClass(me.$options.hideClass), setTimeout(function () {
                callback()
    ...
    destroy: function () {
        function callback() {
            me.$el.remove(),
            0 === $(".lobibox[data-is-modal=true]").length && ($(".lobibox-backdrop").remove(), $("body").removeClass(Lobibox
                .base
                .OPTIONS
                .bodyClass)),
            me._afterClose()
        ...
        me.$options.hideClass
            ? (me
                ...
                .addClass(me.$options.hideClass), setTimeout(function () {
                callback()
            }, me.$options.delayToRemove))
            : callback(),
        this
    ...
    setPosition: function (left, top) {
        var pos;
        return "number" == typeof left && "number" == typeof top
            ? pos = {
                left: left,
                top: top
            }
    ...
    show: function () {
        ...
        return me.$options.modal && ($body.addClass(Lobibox
            .base
            .OPTIONS
            .bodyClass), me._addBackdrop()),
...
LobiboxPrompt.prototype = $.extend({}, LobiboxBase, {
    ...
    _createInput: function () {
        var label,
            me = this;
        return me.$input = me.$options.multiline
            ? $("<textarea></textarea>").attr("rows", me.$options.lines)
            : $('<input type="' + me.$promptType + '"/>'),
        me
            .$input
            .addClass("lobibox-input")
            .attr(me.$options.attrs),
    ...
    isValid: function () {
        ...
        return me.$options.required && ! me.getValue()
            ? (me.$input.addClass("invalid"), 0 === $error.length && (me
                .$el
                .find(".lobibox-body")
                .append('<p class="lobibox-input-error-message">' + me.$options.errorMessage + "</p>"), me._position(), me.$input.focus()), !1)
...
LobiboxWindow.prototype = $.extend({}, LobiboxBase, {
    ...
    _init: function () {
        ...
        me.$options.url && me.$options.autoload
            ? (me.$options.showAfterLoad || me.show(), me.load(function () {
...
text += possible.charAt(Math.floor(Math.random() * possible.length));return text};var Lobibox = Lobibox || {};!function () {var LobiboxNotify = function (type, options) {
this.$type = null,
this.$options = null,
this.$el = null;
var me = this,
    _processInput = function (options) {
        ...
        "mini" !== options.size && options.title === !0
            ? options.title = Lobibox
                .notify
                .OPTIONS[me.$type]
                .title
            : "mini" === options.size && options.title === !0 && (options.title =! 1),
        options.icon === !0 && (options.icon = Lobibox
            .notify
            .OPTIONS
            .icons[options.iconSource][me.$type]),
        options.sound === !0 && (options.sound = Lobibox
            .notify
            .OPTIONS[me.$type]
            .sound),
    ...
    _init = function () {
        ...
        if ("mini" === me.$options.size && $notify.addClass("notify-mini"), "string" == typeof me.$options.position) {
            ...
            $("body").append($notify),
            $notify.css({position: "fixed", left: me
                    .$options
                    .position
                    .left, top: me
                    .$options
...
_init()};Lobibox.notify = function (type, options) {
...
iconSource: "bootstrap",
rounded: !1,
messageHeight: 60},Lobibox.notify.OPTIONS = {
"class": "animated-fast",
large: {
    width: 500,
    messageHeight: 96
